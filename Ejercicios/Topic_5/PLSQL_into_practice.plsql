...
-- 4.
CREATE OR REPLACE PROCEDURE fact (k IN NUMBER(2)) AS
DECLARE
    n NUMBER(2);
    f NUMBER(8);
BEGIN
...
-- 5.
CREATE OR REPLACE FUNCTION CountRef (PayerName IN CHAR) RETURN NUMBER IS
    amount NUMBER(3);
BEGIN
    SELECT COUNT(estate)
    INTO amount
...
-- 6.
SELECT CountRef('ZAMBRANA') from dual;


-- 7.
DROP PROCEDURE NameOfTheProcedure;
DROP FUNCTION NameOfTheFunction;

DROP PROCEDURE fact;
DROP FUNCTION CountRef;